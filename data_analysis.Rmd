...
master_data[["single_CV"]] <- single_CV # 202157DVGXE_polo H2 = 0.99
```
...
met_results <- met_analysis(obj, 
                            filter_traits = 
                              trait_ideal[!trait_ideal %in% c("CBB_3mon",
                                                              "frogskin1_5",
...
BLUEs_BLUPs <- BLUEs_BLUPs %>% 
  relocate(colnames(BLUEs_BLUPs)[str_detect(colnames(BLUEs_BLUPs), "DM_gravity|yield_ha|WAB_30min")], .after = genotype)
